...
The pinned dependencies are the same, though there are subtle differences in output:

```
myst v3.0.1: MdParserConfig(... enable_extensions={'deflist', 'substitution', 'linkify'}, ...
myst v3.0.1: MdParserConfig(... enable_extensions={'substitution', 'deflist', 'linkify'}, ...
```
